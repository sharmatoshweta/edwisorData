...
// function to find a particular entry by its position.(here i am printing only full name of user)

 var position = function(positionData){
	productName = data[positionData].productName;
